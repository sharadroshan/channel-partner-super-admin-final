...
const Allusers = React.lazy(() => import('../pages/channel-partner/all-users/Index'));
...
const Reward = React.lazy(() => import('../pages/channel-partner/miscellaneous/reward/index'));
...
//Admin Manager 
const AdminManager = React.lazy(() => import('../pages/channel-partner/admin-manager/index'));
...
const TotalTransactionHistory = React.lazy(
  () => import("../pages/channel-partner/dashboard/transactions-history/Index")
);
...
const FarmerDashbaordRoutes = {
  ...
  children: [
    ...
    {
      path: "/channel/total-transactions-history",
