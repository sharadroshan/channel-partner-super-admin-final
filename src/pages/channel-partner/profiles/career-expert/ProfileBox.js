...
const UserBox = () => {
  ...
  return (
    <Card className="text-center">
      <Card.Body>
        <h3 className="text-primary">Career Expert</h3>
        <img
        ...
        <div className="text-start mt-3">
          ...
          <table className="table -table-bordered border">
            <tr>
              <th className="text-primary p-1"> English Speaking</th>
              <td>27 march 2010</td>
            </tr>
            <tr>
              <th className="text-primary p-1">Tofel</th>
              <td>21 march 2010</td>
            </tr>
            <tr>
              <th className="text-primary p-1">Higher Education</th>
              <td>20 feb 2015</td>
            </tr>
            <tr>
              <th className="text-primary p-1"> Jobs</th>
              <td>10</td>
            </tr>
          </table>
